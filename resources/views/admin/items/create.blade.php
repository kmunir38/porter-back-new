        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              {!! Form::open(array('route' => 'item.store','method'=>'POST', 'files' => true)) !!}
                <div class="card-body">
                ...
                <div class="form-group row mb-4">
                  ...
                  <div class="col-sm-12 col-md-7">
                    {!! Form::select('restaurant_id', $restaurants, null, array('placeholder' => 'Select Restaurant', 'class' => 'form-control selectric')) !!}
                  </div>
                </div>
                 <div class="form-group row mb-4">
